...
Базовая статичная верстка страницы по Figma завершена (все секции, адаптив, анимации). Репозиторий подготовлен к деплою на Vercel. Следующий этап — перенос в WordPress-тему и ACF Pro.
